      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          ...
          <li class="dropdown">
			...
			<b><?= $full_name ?> <i class="icon wb-chevron-down-mini" aria-hidden="true"></i></b>
			</a>
        ...
        <div>
          <ul class="site-menu">
			...
			<li class="site-menu-item ">
              <a href="#" data-slug="Search Jobseeker">
                <?php echo $this->Html->image('/img/profile.png',['class'=>'site-menu-icon wb-dashboard','aria-hidden'=>'true']); ?>
                <span class="site-menu-title">Job Seekers Profile</span>
              </a>
            </li>
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="#" data-slug="dashboard-v1">
                    ...
                    <span class="site-menu-title">Post Jobs</span>
                  </a>
                </li>
                <li class="site-menu-item">
